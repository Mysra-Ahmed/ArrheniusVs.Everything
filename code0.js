...
gdjs.MainMenuCode.GDAboutMarkerObjects1= [];
gdjs.MainMenuCode.GDAboutMarkerObjects2= [];
gdjs.MainMenuCode.GDAboutTextObjects1= [];
gdjs.MainMenuCode.GDAboutTextObjects2= [];
...
gdjs.copyArray(runtimeScene.getObjects("AboutMarker"), gdjs.MainMenuCode.GDAboutMarkerObjects1);
...
}{for(var i = 0, len = gdjs.MainMenuCode.GDAboutMarkerObjects1.length ;i < len;++i) {
    gdjs.MainMenuCode.GDAboutMarkerObjects1[i].hide();
}
...
for (var i = 0, k = 0, l = gdjs.MainMenuCode.GDAboutObjects1.length;i<l;++i) {
    if ( gdjs.MainMenuCode.GDAboutObjects1[i].getBehavior("ButtonFSM").IsHovered((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.MainMenuCode.GDAboutObjects1[k] = gdjs.MainMenuCode.GDAboutObjects1[i];
        ++k;
    }
}
gdjs.MainMenuCode.GDAboutObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.MainMenuCode.GDAboutObjects1 */
...
for(var i = 0, len = gdjs.MainMenuCode.GDAboutObjects1.length ;i < len;++i) {
    gdjs.MainMenuCode.GDAboutObjects1[i].enableEffect("Effect", true);
}
}}
...
for(var i = 0, len = gdjs.MainMenuCode.GDAboutObjects1.length ;i < len;++i) {
    gdjs.MainMenuCode.GDAboutObjects1[i].enableEffect("Effect", false);
}
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.MainMenuCode.GDAboutObjects1.length;i<l;++i) {
    if ( gdjs.MainMenuCode.GDAboutObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.MainMenuCode.GDAboutObjects1[k] = gdjs.MainMenuCode.GDAboutObjects1[i];
        ++k;
    }
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("AboutMarker"), gdjs.MainMenuCode.GDAboutMarkerObjects1);
{gdjs.evtTools.tween.tweenCamera2(runtimeScene, "CameraMove", (( gdjs.MainMenuCode.GDAboutMarkerObjects1.length === 0 ) ? 0 :gdjs.MainMenuCode.GDAboutMarkerObjects1[0].getCenterXInScene()), gdjs.evtTools.camera.getCameraY(runtimeScene, "", 0), "", "easeInOutQuad", 1);
}}
...
gdjs.MainMenuCode.GDAboutMarkerObjects1.length = 0;
gdjs.MainMenuCode.GDAboutMarkerObjects2.length = 0;
gdjs.MainMenuCode.GDAboutTextObjects1.length = 0;
gdjs.MainMenuCode.GDAboutTextObjects2.length = 0;
