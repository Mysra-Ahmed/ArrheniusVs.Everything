...
gdjs.GameCode.GDTailObjects1= [];
gdjs.GameCode.GDTailObjects2= [];
gdjs.GameCode.GDTailObjects3= [];
gdjs.GameCode.GDTailObjects4= [];
gdjs.GameCode.GDTailObjects5= [];
...
gdjs.GameCode.asyncCallback20182860 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.GameCode.asyncCallback20182860(runtimeScene, asyncObjectsList)));
}
}
...
{for(var i = 0, len = gdjs.GameCode.GDPlayerObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerObjects2[i].getBehavior("Animation").setAnimationName("n");
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0).getChild("CurrentEXP")) >= runtimeScene.getScene().getVariables().getFromIndex(0).getChild("MaxEXP").getAsNumber();
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Menu"), gdjs.GameCode.GDMenuObjects1);
gdjs.copyArray(runtimeScene.getObjects("Transition"), gdjs.GameCode.GDTransitionObjects1);
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDMenuObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDMenuObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_1 = true;
        gdjs.GameCode.GDMenuObjects1[k] = gdjs.GameCode.GDMenuObjects1[i];
        ++k;
    }
}
gdjs.GameCode.GDMenuObjects1.length = k;
if (isConditionTrue_1) {
isConditionTrue_1 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDTransitionObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDTransitionObjects1[i].getBehavior("FlashTransitionPainter").PaintEffectIsEnd((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_1 = true;
        gdjs.GameCode.GDTransitionObjects1[k] = gdjs.GameCode.GDTransitionObjects1[i];
        ++k;
    }
}
gdjs.GameCode.GDTransitionObjects1.length = k;
}
...
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "MainMenu", false);
    ...
    gdjs.GameCode.GDGunObjects1[i].getBehavior("Animation").pauseAnimation();
}
}{gdjs.deviceVibration.stopVibration();
}{gdjs.evtTools.sound.playSound(runtimeScene, "Gun", false, 0, gdjs.randomFloatInRange(0.8, 1));
}}
...
gdjs.GameCode.GDTailObjects1.length = 0;
gdjs.GameCode.GDTailObjects2.length = 0;
gdjs.GameCode.GDTailObjects3.length = 0;
gdjs.GameCode.GDTailObjects4.length = 0;
gdjs.GameCode.GDTailObjects5.length = 0;
